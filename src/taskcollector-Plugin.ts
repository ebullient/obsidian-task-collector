...
export class TaskCollectorPlugin extends Plugin {
    ...
    async onload(): Promise<void> {
        ...
        const markTaskCommand: Command = {
            ...
            icon: "tc-mark-item",
            editorCallback: (editor: Editor, view: MarkdownView) => {
                new TaskMarkModal(this.app, editor, view, this.taskCollector).open();
            }
        };
                ...
                this.app.workspace.on("editor-menu", (menu) => {
                    ...
                    if (this.taskCollector.settings.rightClickMark) {
                        menu.addItem((item) => item
                            ...
                            .onClick(() => {
                                //@ts-ignore
                                this.app.commands.executeCommandById(markTaskCommand.id);
                            })
                        );
                    }
